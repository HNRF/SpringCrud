...
public class ExporterPDF {
	...
	public ExporterPDF(List<Libros> listaLibros) {
		super();
	...
	private void escribirCabeceraDeLaTabla(PdfPTable tabla) {
		...
		celda.setPhrase(new Phrase("fecha_publicacion", fuente));
		tabla.addCell(celda);
	...
	private void escribirDatosDeLaTabla(PdfPTable tabla) {
		for (Libros libros : listaLibros) {
			tabla.addCell(String.valueOf(libros.getId()));
			tabla.addCell(libros.getTitulo());
			tabla.addCell(libros.getAutor());
			tabla.addCell(libros.getGenero());
			tabla.addCell(libros.getFecha_publicacion().toString());
			tabla.addCell(String.valueOf(libros.getPrecio()));
		}
	}
